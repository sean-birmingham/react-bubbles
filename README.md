...
- [ ] Explain what a token is used for.
      ...
      It is used to authenticate users. Only the approved users can access protected routes.

- [ ] What steps can you take in your web apps to keep your data secure?

      Use protected routes so that only the people who have the correct credentials can view the private pages. Also using axiosWithAuth is helpful because axios will only be called if there's a token present.

* [ ] Describe how web servers work.

      A web server processes incoming network requests over HTTP and several other related protocols. The primary function is to store, process, and deliver web pages to clients.

* [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
        
       C: Create/post, R: Read/get, U: Update/put, D: Delete
